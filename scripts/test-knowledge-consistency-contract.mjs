...
assert.ok(mainSource.includes('./modules/assets.js?v=136'));
...
assert.ok(workspaceSource.includes('/modules/assets.js?v=136'));
assert.ok(workspaceSource.includes('main.js?v=243'));
